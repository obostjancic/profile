  ...
  return (
    <VSSection className="intro">
      ...
      <div className="summary">
        ...
        GmbH, where I am mostly commited to development of a cloud infrastructure used to automate Machine learning and
        Computer vision processes. Colleagues know me as motivated, communicative and a creative developer who likes to
        help others, and who can be trusted to come up with a solution.
